    ...
    return (
        <div className="mr-[0px] mt-4">
            <div className="flex flex-col text-center ">
                ...
                <div className="w-[630px] h-[350px] bg-black flex justify-center items-center mt-4 rounded ">
                    <i className="fa-solid fa-video text-white text-5xl"></i>
                </div>
            </div>
            <div className="div flex justify-end mt-[30px]">
                <button onClick={openModal} className="w-[440px] h-[50px] px-4 py-2 bg-violet-500 hover:bg-violet-600 text-white font-semibold rounded focus:outline-none focus:ring-2 focus:ring-blue-500">
                    Continue
                </button>
            </div>
